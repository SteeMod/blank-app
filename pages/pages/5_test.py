...
def main():
    ...
    with st.form(key='upload_form'):
        ...
        if uploaded_file is not None and submit_button:
            ...
            response = requests.post('https://new1one.cognitiveservices.azure.com/formrecognizer/v2.1-preview.3/custom/models/Thessa5vs6/analyze', headers=headers, params=params, data=data)
